$(function() {
	...
	new PerfectScrollbar(".header-message-list"), new PerfectScrollbar(".header-notifications-list"), $(".mobile-search-icon").on("click", function() {
		...
		if ($(".wrapper").hasClass("toggled")) {
			icon.removeClass('bx-arrow-to-left').addClass('bx-arrow-to-right');
			...
			icon.removeClass('bx-arrow-to-right').addClass('bx-arrow-to-left');
			
			// Remove hover handlers when expanded
